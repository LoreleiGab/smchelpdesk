...
$hesk_settings['language']='Português do Brasil';
$hesk_settings['languages']=array(
'English' => array('folder'=>'en','hr'=>'------ Reply above this line ------'),
'Português do Brasil' => array('folder'=>'pt-BR','hr'=>'------ Responder acima desta linha ------'),
);
...
$hesk_settings['secimg_sum']='QW9Q43LD69';
...
$hesk_settings['question_ask']='Which of these is not an animal: monkey, horse, tree';
...
$hesk_settings['ticket_list']=array('trackid','dt','lastchange','name','subject','status','owner','lastreplier');
